...
int main() {
	...
	struct tm ash_wednesday = ash_wednesday_from_easter(tm_easter);
	print_tm("Ash Wednesday", ash_wednesday);
	struct tm advent = first_sunday_of_advent(2025);
	print_tm("Advent", advent);
}
